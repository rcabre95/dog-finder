    ...
    return (
        <header className={`w-full h-16 bg-cream flex items-center justify-between fixed z-20`}>
            ...
            <div className={` w-fit px-4 flex justify-between mr-2`}>
                <button className={`border-0 rounded-md mr-2 shadow-sm bg-burnt text-cream disabled:bg-slate-400 w-16 h-8 hover:border hover:text-burnt hover:bg-cream hover:border-burnt transition-colors duration-300`} disabled={disabled()} onClick={toggleFilters} >Filters</button>
